...
#read a text file with wikipedia uuniversities url
'''
...
print str(k) + " universities tried"
...
with open('failed.txt', 'w') as outfile:
    ...
    outfile.write(str(k) + " universities recorded\n")
...
with codecs.open('unidic.csv', encoding ='utf-8', mode ='w+') as csvout:
    ...
    writer = csv.DictWriter(csvout, fieldnames=unisl[0].keys())
